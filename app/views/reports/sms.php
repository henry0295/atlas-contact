    ...
    <div class="container-xl">
                        ...
                        <div>
                            ...
                            <div class="dropdown d-inline-block">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="<?= URLROOT ?>/reports/export?type=sms&format=excel&start_date=<?= $data['startDate'] ?>&end_date=<?= $data['endDate'] ?>">
                                        Excel
                                    </a>
                                    <a class="dropdown-item" href="<?= URLROOT ?>/reports/export?type=sms&format=csv&start_date=<?= $data['startDate'] ?>&end_date=<?= $data['endDate'] ?>">
                                        CSV
                                    </a>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="subheader">Total SMS</div>
                        </div>
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div id="chart-sms-activity" style="height: 300px;"></div>
            </div>
        </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var chart = new ApexCharts(document.querySelector("#chart-sms-activity"), options);
    chart.render();
});
</script>
