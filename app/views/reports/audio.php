    ...
    <div class="container-xl">
                        ...
                        <div>
                            ...
                            <div class="dropdown d-inline-block">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="<?= URLROOT ?>/reports/export?type=audio&format=excel&start_date=<?= $data['startDate'] ?>&end_date=<?= $data['endDate'] ?>">
                                        Excel
                                    </a>
                                    <a class="dropdown-item" href="<?= URLROOT ?>/reports/export?type=audio&format=csv&start_date=<?= $data['startDate'] ?>&end_date=<?= $data['endDate'] ?>">
                                        CSV
                                    </a>
                                </div>
                            </div>
        ...
        <div class="row row-deck row-cards mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="subheader">Total Llamadas</div>
                        </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="subheader">Contestadas</div>
                        </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="subheader">No Contestadas</div>
                        </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="subheader">Tasa de Respuesta</div>
                        </div>
                        <div class="h1">
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div id="chart-audio-activity" style="height: 300px;"></div>
            </div>
        </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var chart = new ApexCharts(document.querySelector("#chart-audio-activity"), options);
    chart.render();
});
</script>
