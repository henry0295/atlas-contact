            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Enviar SMS</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?= BASE_URL ?>sms/send">
                            <div class="mb-3">
                                <label class="form-label">Nombre de la campaña</label>
                                <input type="text" class="form-control" name="campaign" placeholder="Ej: Promoción_Navidad_2025" value="<?= $data['post']['campaign'] ?? '' ?>">
                                <div class="form-text">Opcional. Si no se especifica, se generará automáticamente.</div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Número de teléfono</label>
                                <input type="text" class="form-control" name="recipient" placeholder="Ej: +57999999999" value="<?= $data['post']['recipient'] ?? '' ?>" required>
